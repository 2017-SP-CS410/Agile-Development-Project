...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    'C:\\Program Files (x86)\\Python36-32',
    'default_mod_dir':    'C:\\Program Files (x86)\\Python36-32\\Lib\\site-packages',
    'default_sip_dir':    'C:\\Program Files (x86)\\Python36-32\\sip',
    'deployment_target':  '',
    'platform':           'win32-borland',
    'py_conf_inc_dir':    'C:\\Program Files (x86)\\Python36-32\\include',
    'py_inc_dir':         'C:\\Program Files (x86)\\Python36-32\\include',
    'py_lib_dir':         'C:\\Program Files (x86)\\Python36-32\\libs',
    'py_version':         0x030600,
    'qt_framework':       0,
    'sip_bin':            'C:\\Program Files (x86)\\Python36-32\\sip',
    'sip_config_args':    '--platform win32-borland',
    'sip_inc_dir':        'C:\\Program Files (x86)\\Python36-32\\include',
    'sip_mod_dir':        'C:\\Program Files (x86)\\Python36-32\\Lib\\site-packages',
...
_default_macros = {
    ...
    'CXXFLAGS':                 '-tWR -tWM',
    'CXXFLAGS_APP':             '',
    'CXXFLAGS_CONSOLE':         '-tWC',
    'CXXFLAGS_DEBUG':           '-v',
    'CXXFLAGS_EXCEPTIONS_OFF':  '-x-',
    ...
    'INCDIR_X11':               '',
    'LFLAGS':                   '-c -x -Gn',
    'LFLAGS_CONSOLE':           '-ap -Tpe c0x32.obj',
    'LFLAGS_CONSOLE_DLL':       '',
    'LFLAGS_DEBUG':             '-v',
    'LFLAGS_DLL':               '-Gi -aa -Tpd c0d32.obj',
    'LFLAGS_OPENGL':            '',
    'LFLAGS_PLUGIN':            '',
    'LFLAGS_RELEASE':           '',
    'LFLAGS_RPATH':             '',
    ...
    'LFLAGS_SONAME':            '',
    'LFLAGS_THREAD':            '',
    'LFLAGS_WINDOWS':           '-aa -Tpe c0w32.obj',
    'LFLAGS_WINDOWS_DLL':       '',
    'LIB':                      'tlib /C /P256',
    'LIBDIR':                   '\\lib',
    'LIBDIR_OPENGL':            '',
